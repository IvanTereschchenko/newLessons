...
const App = () => {
  ...
  return (
    <div className="MainContainer">
      ...
      <ShopingInfo totalSum={totalSum} numberOfGoods={numberOfGoods} totalItems={totalItems} avargePrice={avargePrice}></ShopingInfo>
      <button className="Ordering" onClick={() => setModalActive(true)}> Ordering form</button>
